          ...
          <GridRow>
            <HomepageContent>
              ...
              <p>
                ...
                You will need 2 devices. 1 for Kahoot and 1 for Zoom<br/>
              </p>
              <hr />
              <p>
                <strong>Zoom Video</strong><br/>
                Join zoom with on your first device<br/>
                Ideally this is a tablet or laptop with a larger screen to see the quiz questions<br/>
                <a href="https://us04web.zoom.us/j/74788315752?pwd=cE1HaURtUmtVRGRsby85V3d4a1lJQT09">http://katesbirthday.zoom.com</a><br/>
                <br/>
              </p>
              <p>
                <strong>Kahoot quiz</strong><br/>
                Join Kahoot! quiz on your second device<br/>
                Ideally this is a phone as it is easy to hold and select the answers<br/>
                <a href="http://katesbirthday.kahoot.com">http://katesbirthday.kahoot.com</a><br/>
                <br/>
              </p>
